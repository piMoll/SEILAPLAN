...
class Ui_AdjustmentDialogUI(object):
    def setupUi(self, AdjustmentDialogUI):
        ...
        self.DescLayout.addWidget(self.label_7)
        ...
        self.DescLayout.addWidget(self.label_16)
    ...
    def retranslateUi(self, AdjustmentDialogUI):
        ...
        self.label_16.setText(_translate("AdjustmentDialogUI", "Konfiguration der Stuetzen fuer die Darstellung in der Vogelperspektive. Die Vogelperspektive kann in den Speicheroptionen aktiviert werden. Sie ist Teil des Diagramm-Exports und wird unterhalb der Profilansicht im PDF ausgegeben. "))
