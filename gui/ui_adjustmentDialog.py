...
class Ui_AdjustmenDialog(object):
    def setupUi(self, AdjustmenDialog):
        ...
        AdjustmenDialog.resize(599, 407)
        ...
        self.btnCancel = QtWidgets.QPushButton(AdjustmenDialog)
        self.btnCancel.setObjectName("btnCancel")
        self.buttonLayout.addWidget(self.btnCancel)
        self.gridLayout_2.addLayout(self.buttonLayout, 3, 0, 1, 1)
    ...
    def retranslateUi(self, AdjustmenDialog):
        ...
        AdjustmenDialog.setWindowTitle(_translate("AdjustmenDialog", "Dialog"))
        ...
        self.label_22.setText(_translate("AdjustmenDialog", "Technische Kennwerte der berechneten Seillinie"))
        self.label_29.setText(_translate("AdjustmenDialog", "Max. resultierende Sattelkraft"))
        self.label_34.setText(_translate("AdjustmenDialog", "an befahrbarer Stütze, Last auf Stütze"))
        self.label_39.setText(_translate("AdjustmenDialog", "Seilwinkel am Lastseil"))
        self.label_40.setText(_translate("AdjustmenDialog", "(optimaler Bereich 0° - 30°)"))
        self.label_23.setText(_translate("AdjustmenDialog", "Kennwert"))
        self.label_41.setText(_translate("AdjustmenDialog", "Nachweis erbracht"))
        self.label_42.setText(_translate("AdjustmenDialog", "Seil hebt nicht von Sattel ab"))
        self.label_25.setText(_translate("AdjustmenDialog", "aktuelle Seillinie"))
        self.label_32.setText(_translate("AdjustmenDialog", "Max. auftretende Seilzugkraft"))
        self.label_33.setText(_translate("AdjustmenDialog", "Last in Feldmitte des längsten Seilfelds"))
        self.label_24.setText(_translate("AdjustmenDialog", "Definierter Grenzwert"))
        self.label_26.setText(_translate("AdjustmenDialog", "Minimaler Bodenabstand"))
        self.label_43.setText(_translate("AdjustmenDialog", "<html><head/><body><p><img src=\":/plugins/SeilaplanPlugin/gui/icons/icon_yellow.png\"/></p></body></html>"))
        self.label_44.setText(_translate("AdjustmenDialog", "<html><head/><body><p><img src=\":/plugins/SeilaplanPlugin/gui/icons/icon_yellow.png\"/></p></body></html>"))
        self.label_45.setText(_translate("AdjustmenDialog", "<html><head/><body><p><img src=\":/plugins/SeilaplanPlugin/gui/icons/icon_yellow.png\"/></p></body></html>"))
        self.label_46.setText(_translate("AdjustmenDialog", "<html><head/><body><p><img src=\":/plugins/SeilaplanPlugin/gui/icons/icon_yellow.png\"/></p></body></html>"))
        self.label_47.setText(_translate("AdjustmenDialog", "<html><head/><body><p><img src=\":/plugins/SeilaplanPlugin/gui/icons/icon_yellow.png\"/></p></body></html>"))
        ...
        item.setText(_translate("AdjustmenDialog", "New Row"))
        ...
        item.setText(_translate("AdjustmenDialog", "Kennwert"))
        item = self.tableThresholds.horizontalHeaderItem(1)
        item.setText(_translate("AdjustmenDialog", "Def. Grenzwert"))
        item = self.tableThresholds.horizontalHeaderItem(2)
        item.setText(_translate("AdjustmenDialog", "aktuelle Seillinie"))
        ...
        item.setText(_translate("AdjustmenDialog", "Minimaler Bodenabstand"))
        item = self.tableThresholds.item(1, 0)
        item.setText(_translate("AdjustmenDialog", "Max. auftretende Seilzugkraft am Lastseil (Last in Feldmitte des längsten Seilfeldes)"))
        item = self.tableThresholds.item(2, 0)
        item.setText(_translate("AdjustmenDialog", "Resultierende Sattelkraft (an befahrbarer Stütze, Last auf Stütze)"))
        item = self.tableThresholds.item(3, 0)
        item.setText(_translate("AdjustmenDialog", "Seilwinkel am Lastseil (optimaler Bereich 0° - 30°)"))
        item = self.tableThresholds.item(4, 0)
        item.setText(_translate("AdjustmenDialog", "Nachweis erbracht, dass Seil nicht vom Sattel abhebt"))
        self.tableThresholds.setSortingEnabled(__sortingEnabled)
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabThreshold2), _translate("AdjustmenDialog", "Kennwerte2"))
        ...
        self.btnSave.setText(_translate("AdjustmenDialog", "Ergebnisse speichern"))
        self.btnCancel.setText(_translate("AdjustmenDialog", "Abbrechen"))
