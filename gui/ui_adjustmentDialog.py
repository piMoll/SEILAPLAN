...
class Ui_AdjustmentDialogUI(object):
    def setupUi(self, AdjustmentDialogUI):
        ...
        self.fieldPrNr = QtWidgets.QLineEdit(self.tab)
        ...
        self.fieldPrVerf = QtWidgets.QLineEdit(self.tab)
    ...
    def retranslateUi(self, AdjustmentDialogUI):
        ...
        self.label_43.setText(_translate("AdjustmentDialogUI", "Stuetzenbezeichnung"))
...
"(erscheint in Berichten)"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("AdjustmentDialogUI", "Kopfdaten"))
