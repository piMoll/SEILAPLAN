...
class Ui_AdjustmenDialog(object):
    ...
    def retranslateUi(self, AdjustmenDialog):
        ...
        self.label_9.setText(_translate("AdjustmenDialog", "Gewicht Rückholseil"))
        ...
        self.label.setText(_translate("AdjustmenDialog", "Minimaler Abstand Tragseil - Boden"))
        self.label_15.setText(_translate("AdjustmenDialog", "kN"))
        self.label_22.setText(_translate("AdjustmenDialog", "m"))
        self.label_8.setText(_translate("AdjustmenDialog", "Gewicht Zugseil"))
        self.label_12.setText(_translate("AdjustmenDialog", "Mindestbruchkraft Tragseil"))
        self.label_23.setText(_translate("AdjustmenDialog", "kN"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabCableline), _translate("AdjustmenDialog", "Tragsystem"))
