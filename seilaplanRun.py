...
class SeilaplanRun:
    ...
    def startOptimization(self):
        ...
        self.progressDialog = ProgressDialog(
            self.iface.mainWindow(), self.onCloseProgressWindow
        )
    ...
    def showAdjustmentWindow(self, result, resultQuality):
        ...
        self.adjustmentWindow = AdjustmentDialog(
            self.iface, self.confHandler, self.onCloseAdjustmentWindow
        )
