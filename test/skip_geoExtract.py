...
class TestCalcProfile(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.points = cls.project.points["A"] + cls.project.points["E"]
    ...
    def test_profile_generation(self):
        ...
        xi_disp = np.load(
            os.path.join(TESTDATA_DIR, "geoExtract_legacy_raster_xi_disp.npy")
        )
        ...
        zi_disp = np.load(
            os.path.join(TESTDATA_DIR, "geoExtract_legacy_raster_zi_disp.npy")
        )
    ...
    def test_anchor_calculation(self):
        ...
        gp, zi_disp, di_ind = calcProfile(
            self.points, oldRas, self.inputData_, 1, coeff
        )
        ...
        self.assertAlmostEqual(
            first_anchor_["field"][0], self.poles.anchor["field"][0], 3
        )
        self.assertAlmostEqual(
            first_anchor_["field"][1], self.poles.anchor["field"][1], 3
        )
        self.assertAlmostEqual(
            first_anchor_["field"][2], self.poles.anchor["field"][2], 3
        )
        self.assertAlmostEqual(
            first_anchor_["field"][3], self.poles.anchor["field"][3], 3
        )
        # Compare length
        ...
        # Compare anchor fields
        self.assertAlmostEqual(
            updated_anchor["field"][0], self.poles.anchor["field"][0], 3
        )
        self.assertAlmostEqual(
            updated_anchor["field"][1], self.poles.anchor["field"][1], 3
        )
        self.assertAlmostEqual(
            updated_anchor["field"][2], self.poles.anchor["field"][2], 3
        )
        self.assertAlmostEqual(
            updated_anchor["field"][3], self.poles.anchor["field"][3], 3
        )
        # Compare length
