...
class TestRaster(unittest.TestCase):
    ...
    def test_collect_raster_properties_from_path(self):
        ...
        self.assertEqual(
            self.raster.extent, [2744155.5, 1190227.0, 2745332.5, 1189289.0]
        )
    ...
    def test_collect_raster_properties_from_qgis_layer(self):
        ...
        self.assertEqual(raster.extent, [2744155.5, 1190227.0, 2745332.5, 1189289.0])
    ...
    def test_collect_raster_properties_from_xyz_file_path(self):
        ...
        self.assertEqual(raster.extent, [454999.5, 5299000.5, 456000.5, 5298449.5])
        self.assertTrue(raster.valid)
