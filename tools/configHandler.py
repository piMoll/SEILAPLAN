...
class ConfigHandler:
    ...
    TEMPLATES_URL = (
        "https://raw.githubusercontent.com/piMoll/SEILAPLAN/master/templates/"
    )
    TEMPLATE_FILENAME = {
        "excelProtocol": {
    ...
    def updateUserSettings(self):
        ...
        s.setValue(
            f"{self.SETTING_PREFIX}shortReport",
        ...
        s.setValue(
            ...
            self.outputOptions["birdViewLegend"],
        )
    ...
    def addPath(self, path):
        ...
        [
            unique.append(item)
            for item in reversed(self.commonPaths)
    ...
    def qgsSettingsMigrator(self):
        ...
        for migration in migrations:
            ...
            if newVal == -1:
                ...
                oldVal = s.value(
                    f"{self.SETTING_PREFIX}{migration['old']}",
                    migration["default"],
                    int,
                )
                # Update settings
